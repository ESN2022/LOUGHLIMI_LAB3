...
module pd_mm_interconnect_0 (
	...
	wire  [13:0] opencores_i2c_0_avalon_slave_0_agent_m0_address;                                    // opencores_i2c_0_avalon_slave_0_agent:m0_address -> opencores_i2c_0_avalon_slave_0_translator:uav_address
	...
	wire  [90:0] opencores_i2c_0_avalon_slave_0_agent_rf_source_data;                                // opencores_i2c_0_avalon_slave_0_agent:rf_source_data -> opencores_i2c_0_avalon_slave_0_agent_rsp_fifo:in_data
	...
	wire  [90:0] opencores_i2c_0_avalon_slave_0_agent_rsp_fifo_out_data;                             // opencores_i2c_0_avalon_slave_0_agent_rsp_fifo:out_data -> opencores_i2c_0_avalon_slave_0_agent:rf_sink_data
	...
	wire  [89:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> opencores_i2c_0_avalon_slave_0_agent:cp_data
	...
	wire  [89:0] opencores_i2c_0_avalon_slave_0_agent_rp_data;                                       // opencores_i2c_0_avalon_slave_0_agent:rp_data -> router_003:sink_data
	...
	wire  [89:0] timer_0_s1_agent_rp_data;                                                           // timer_0_s1_agent:rp_data -> router_006:sink_data
	...
	pd_mm_interconnect_0_router router (
	...
	pd_mm_interconnect_0_router_001 router_001 (
	...
	pd_mm_interconnect_0_router_002 router_002 (
	...
	pd_mm_interconnect_0_router_002 router_003 (
	...
	pd_mm_interconnect_0_router_004 router_004 (
	...
	pd_mm_interconnect_0_router_004 router_005 (
	...
	pd_mm_interconnect_0_router_002 router_006 (
	...
	pd_mm_interconnect_0_router_002 router_007 (
	...
	pd_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                          //        clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	pd_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                 //        clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	pd_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pd_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                           //       clk.clk
		.reset               (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pd_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pd_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pd_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pd_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pd_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pd_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                           //       clk.clk
		.reset              (opencores_i2c_0_clock_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pd_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pd_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pd_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pd_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pd_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pd_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pd_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
